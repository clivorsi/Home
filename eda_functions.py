class regression:
    """commonly used eda functions for regression models"""
...
class classification:
    """commonly used eda functions for classification models"""
    ...
    def boxplot_loop(self):
        ...
        warnings.filterwarnings("ignore")
        for col in self._num_features:
            self._df.boxplot(column=col, by=self._label, figsize=(6,6))
            plt.title(col)
        plt.show()
